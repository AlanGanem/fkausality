...
__all__ = ['sigmoid', 'make_bimodal_assymetric_regression', 'sparsify', 'hstack', 'vstack', 'stack', 'RobustEncoder',
           ...
           'RegressionLinearBottleneck', 'MLPKernel', 'BOWKernel', 'sigmoid', 'make_bimodal_assymetric_regression',
           'sparsify', 'hstack', 'vstack', 'stack', 'RobustEncoder', 'EstimatorKernel', 'JaccardForestKernel',
